...
import com.my.section01.entitymanager.EntityManagerGenerator;
import jakarta.persistence.EntityManager;
import jakarta.persistence.EntityTransaction;

/* EntityManager를 이용하여 JPA CRUD */
public class EntityManagerCRUD {
  private EntityManager entityManager; //가상의 데이터베이스
  ...
  public Menu findMenuByMenuCode(int menuCode){
    ...
    *  조회 결과를 Menu.class로 만든 객체에 담아서 반환
    *  */
  ...
  public Long saveAndReturnAllCount(Menu newMenu){
    ...
    // 트랜잭션을 얻어와서 시작
    // JPA 쓰기 작업(INSERT, UPDATE, DELETE)시 필수로 작성
  ...
  public Menu modifyMenuName(int menuCode, String menuName) {
    ...
    // -> commit, flush 수행 시 해당 내용이 DB에 반영 됨.
