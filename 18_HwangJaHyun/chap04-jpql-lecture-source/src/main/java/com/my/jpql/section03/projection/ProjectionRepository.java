package com.my.jpql.section03.projection;

import com.my.jpql.section03.projection.MenuInfo;
...
public class ProjectionRepository {
  ...
  public List<MenuInfo> embeddedTypeProjection() {
    ...
    // 영속성 컨텍스트에서 관리 X
    // -> MenuInfo에는 @Entity 어노테이션 없음 == 엔티티 아님
  ...
  * */
  ...
  public List<CategoryInfo> newCommandProjection() {
    String jpql
        = "SELECT new com.my.jpql.section03.projection.CategoryInfo"
        + "(c.categoryCode, c.categoryName) FROM Section03Category c";
        // 매개변수가 2개인 생성자 이용해서 만들겠다.
