package com.my.nativequery.section01.simple;
...
public class NativeQueryRepository {
  ...
  /* Native Query 수행 결과를 엔티티 클래스에 매핑 시키기 위해서는 모든 컬럼이 처리되어야만 한다.
  * == 엔티티 클래스의 한 필드라도 값을 매핑시키지 않으면 오류 발생 */
  ...
  public List<Object[]> nativeQueryByNoResultType() {
    /* 컬럼을 2개만 조회하기 때문에 Menu엔티티 클래스에 매핑 불가
    * -> Object[]로 값 저장
    * */
